Title: Module http.matchers.client_country - Caddy Documentation

URL Source: https://caddyserver.com/docs/modules/http.matchers.client_country

Markdown Content:
Module http.matchers.client_country - Caddy Documentation
...
Module http.matchers.client_country
===================================

 There is more than one module named **Module http.matchers.client_country**. Choose one by its repository. 
...
Description[🔗](https://caddyserver.com/docs/modules/http.matchers.client_country#docs "Direct link")
-----------------------------------------------------------------------------------------------------

Field List
----------

▸git.gorbe.io/caddy/geoip.git
...
http.matchers.client_country matches requests by the client_ip GeoIP Country.
...
`{"level":"info", ... ,"logger":"http.matchers.client_country","msg":"Request matched","client_ip":"...", "country": "..."}`

Field List
----------

[🔗](https://caddyserver.com/docs/modules/http.matchers.client_country#countries)countries
