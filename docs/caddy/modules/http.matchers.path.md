Title: Module http.matchers.path - Caddy Documentation

URL Source: https://caddyserver.com/docs/modules/http.matchers.path

Markdown Content:
Module http.matchers.path - Caddy Documentation
...
=========================
 ...
 There is more than one module named **Module http.matchers.path**. Choose one by its repository. 
...
Description[🔗](https://caddyserver.com/docs/modules/http.matchers.path#docs "Direct link")
-------------------------------------------------------------------------------------------
...
http.matchers.path case-insensitively matches requests by the URI's path. Path matching is exact, not prefix-based, giving you more control and clarity over matching. Wildcards (`*`) may be used:
