...
Description[🔗](https://caddyserver.com/docs/modules/http.handlers.encode#docs "Direct link")
---------------------------------------------------------------------------------------------
...
```
{▾	"encodings": {•••},	"prefer": [""],	"minimum_length": 0,	"match": {▾		"status_code": [0],		"headers": {
			"": [""]
		}	}}
```
...
[🔗](https://caddyserver.com/docs/modules/http.handlers.encode#encodings)encodings
...
[🔗](https://caddyserver.com/docs/modules/http.handlers.encode#prefer)prefer
If the client has no strong preference, choose these encodings in order.

[🔗](https://caddyserver.com/docs/modules/http.handlers.encode#minimum_length)minimum_length
Only encode responses that are at least this many bytes long.

[🔗](https://caddyserver.com/docs/modules/http.handlers.encode#match)match
...
[🔗](https://caddyserver.com/docs/modules/http.handlers.encode#match/status_code)match/status_code
...
[🔗](https://caddyserver.com/docs/modules/http.handlers.encode#match/headers)match/headers
