Title: Module http.authentication.providers.http_basic - Caddy Documentation

URL Source: https://caddyserver.com/docs/modules/http.authentication.providers.http_basic

Markdown Content:
Module http.authentication.providers.http_basic - Caddy Documentation
...
===============================================
 ...
 There is more than one module named **Module http.authentication.providers.http_basic**. Choose one by its repository. 
...
Description[🔗](https://caddyserver.com/docs/modules/http.authentication.providers.http_basic#docs "Direct link")
-----------------------------------------------------------------------------------------------------------------
...
`{▾	"hash": {•••},	"accounts": [{▾		"username": "",		"password": ""	}],	"realm": "",	"hash_cache": {▾	}}`
...
http.authentication.providers.http_basic facilitates HTTP basic authentication.

Field List
----------

[🔗](https://caddyserver.com/docs/modules/http.authentication.providers.http_basic#hash)hash
...
[🔗](https://caddyserver.com/docs/modules/http.authentication.providers.http_basic#accounts)accounts
The list of accounts to authenticate.

Account contains a username and password.

[🔗](https://caddyserver.com/docs/modules/http.authentication.providers.http_basic#accounts/username)accounts/username
A user's username.

[🔗](https://caddyserver.com/docs/modules/http.authentication.providers.http_basic#accounts/password)accounts/password
The user's hashed password, in Modular Crypt Format (with `$` prefix) or base64-encoded.

[🔗](https://caddyserver.com/docs/modules/http.authentication.providers.http_basic#realm)realm
The name of the realm. Default: restricted

[🔗](https://caddyserver.com/docs/modules/http.authentication.providers.http_basic#hash_cache)hash_cache
