Title: Module crowdsec - Caddy Documentation

URL Source: https://caddyserver.com/docs/modules/crowdsec

Markdown Content:
Module crowdsec - Caddy Documentation
...
===============
 ...
 There is more than one module named **Module crowdsec**. Choose one by its repository. 
...
Description[🔗](https://caddyserver.com/docs/modules/crowdsec#docs "Direct link")
---------------------------------------------------------------------------------
...
[🔗](https://caddyserver.com/docs/modules/crowdsec#api_key)api_key
APIKey for the CrowdSec Local API

[🔗](https://caddyserver.com/docs/modules/crowdsec#api_url)api_url
APIUrl for the CrowdSec Local API. Defaults to [http://127.0.0.1:8080/](http://127.0.0.1:8080/)

[🔗](https://caddyserver.com/docs/modules/crowdsec#ticker_interval)ticker_interval
TickerInterval is the interval the StreamBouncer uses for querying the CrowdSec Local API. Defaults to "10s".

[🔗](https://caddyserver.com/docs/modules/crowdsec#enable_streaming)enable_streaming
...
[🔗](https://caddyserver.com/docs/modules/crowdsec#enable_hard_fails)enable_hard_fails
