...
Then, create a file named `Caddyfile` as the only file in the `conf` directory, and write your [Caddyfile](https://caddyserver.com/docs/caddyfile/concepts) config.
