Title: apps/http/.../upstreams/max_requests - JSON Config Structure

URL Source: https://caddyserver.com/docs/json/apps/http/servers/routes/handle/reverse_proxy/upstreams/max_requests/

Markdown Content:
apps/http/.../upstreams/max_requests - JSON Config Structure - Caddy Documentation
...
Description[🔗](https://caddyserver.com/docs/json/apps/http/servers/routes/handle/reverse_proxy/upstreams/max_requests/#docs "Direct link")
-------------------------------------------------------------------------------------------------------------------------------------------
