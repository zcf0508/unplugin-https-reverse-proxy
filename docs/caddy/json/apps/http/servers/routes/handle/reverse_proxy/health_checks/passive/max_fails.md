Title: apps/http/.../passive/max_fails - JSON Config Structure

URL Source: https://caddyserver.com/docs/json/apps/http/servers/routes/handle/reverse_proxy/health_checks/passive/max_fails/

Markdown Content:
apps/http/.../passive/max_fails - JSON Config Structure - Caddy Documentation
...
Description[🔗](https://caddyserver.com/docs/json/apps/http/servers/routes/handle/reverse_proxy/health_checks/passive/max_fails/#docs "Direct link")
----------------------------------------------------------------------------------------------------------------------------------------------------
