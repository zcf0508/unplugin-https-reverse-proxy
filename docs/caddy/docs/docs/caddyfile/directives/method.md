Title: method (Caddyfile directive) - Caddy Documentation

URL Source: https://caddyserver.com/docs/caddyfile/directives/method

Markdown Content:
method (Caddyfile directive) — Caddy Documentation
===============  
