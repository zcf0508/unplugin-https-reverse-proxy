Title: fs (Caddyfile directive) - Caddy Documentation

URL Source: https://caddyserver.com/docs/caddyfile/directives/fs

Markdown Content:
fs (Caddyfile directive) — Caddy Documentation
===============  
...
First, you must declare a file system name using the [`filesystem` global option](https://caddyserver.com/docs/caddyfile/options#filesystem), then you can use this directive to specify which file system to use.

This directive is often used in conjunction with the [`file_server` directive](https://caddyserver.com/docs/caddyfile/directives/file_server) to serve static files, or the [`try_files` directive](https://caddyserver.com/docs/caddyfile/directives/try_files) to perform rewrites based on the existence of files. Typically also used with [`root` directive](https://caddyserver.com/docs/caddyfile/directives/root) to set the root path within the file system.
