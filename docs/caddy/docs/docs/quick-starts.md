Title: Quick-starts - Caddy Documentation

URL Source: https://caddyserver.com/docs/quick-starts
...
Quick-starts[🔗](https://caddyserver.com/docs/quick-starts#quick-starts "Direct link")
======================================================================================
...
Menu[🔗](https://caddyserver.com/docs/quick-starts#menu "Direct link")
----------------------------------------------------------------------
...
*   #### [Static file server](https://caddyserver.com/docs/quick-starts/static-files)
