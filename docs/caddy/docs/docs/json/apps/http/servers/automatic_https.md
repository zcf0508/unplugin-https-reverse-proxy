Title: servers/automatic_https - JSON Config Structure

URL Source: https://caddyserver.com/docs/json/apps/http/servers/automatic_https/

Markdown Content:
servers/automatic\_https - JSON Config Structure - Caddy Documentation
=============== 
