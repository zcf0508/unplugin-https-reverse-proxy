Title: storage/file_system - JSON Config Structure

URL Source: https://caddyserver.com/docs/json/storage/file_system/

Markdown Content:
storage/file\_system - JSON Config Structure - Caddy Documentation
=============== 
